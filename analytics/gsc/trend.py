...
# （2026-09-05 に API の次元なし合計と突き合わせて実測）。種別×週次の比較を
...
INTERVENTIONS = [
    ...
    },
    {
        ...
        "criterion": "SERP 実査（analytics/serp/report.py --recheck → --diff）で"
                     ...
                     "⚠⚠ 2026-09-05 追記: 投入前 n=6 の area 観測では title_source と"
                     ...
                     "✅ 2026-09-05: 交絡のうち「クロール鮮度」側は棄却した。"
...
def partial_periods(rows, monthly):
    """日数が揃っていない期間（=未確定）を返す（2026-09-05 追加）。
