...
**信頼度**: 🔴 AI知識ベース（競合サイトの実画面は未確認）

### 問い: ダーク+ゴールドは釣り人に受け入れられるか？

**結論: ゴールドはやめた方がいい。ダークネイビー+オーシャンブルーが最適。**
...
|---------|------------|------|
| DAIWA | 黒+赤 | スポーティ、高級感 |
| SHIMANO | 青系+黒 | テクノロジー、信頼 |
| がまかつ | 赤+黒+金 | 伝統、プロ（やや古い印象） |
| Fishbrain | ダークネイビー+ティール | プレミアム、海 |

**共通**: 暗色ベースが多い。ゴールドは「がまかつ的な年配プロ向け」で、ギャンブル臭さのリスクあり。

### 推奨パレット（A案: ダークネイビー+オーシャンブルー）

```
背景:      #0b1929（深い紺 — 夜明け前の海）
カード:     #132f4c（やや明るい紺）
アクセント:  #29b6f6（明るい海の青）
CTA:       #e85d04（オレンジ — 救命胴衣・浮きの色）
ポジティブ:  #66bb6a（緑 — 好釣果）
ネガティブ:  #ef5350（赤 — 注意・欠航）
テキスト:   #e3f2fd（薄い青白）
サブテキスト: #90a4ae（灰青）
```
...
1. 釣り人にとって「海=ダークネイビー+ブルー」は自然
2. Fishbrain（グローバル最大の釣りアプリ）が同系統で成功
3. 白背景の競合（釣りビジョン・船釣り.jp）と明確に差別化
4. CTAオレンジは救命胴衣・浮きの色で釣り文脈に合う
5. ゴールドの「ギャンブル予想サイト臭さ」を回避

### 注意

- 旧デザインもダークネイビーだったため、**色だけでは差別化にならない**
- 差別化はレイアウト（Bentoグリッド）、演出（スピナー）、UX（ペイウォール）で出す
- 競合スクショ取得後に実際の色使いを確認して再検証が必要（🔴未検証）
